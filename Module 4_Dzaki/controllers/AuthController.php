...
class AuthController
{
            ...
            //    - Jika verifikasi password salah, set session message "Login Gagal NIM atau Password Salah"
                if (password_verify($password, $data['password'])){
                    ...
                    if(isset($_POST['remember_me'])){
                        setcookie('nim', $data_mahasiswa['nim'], time() - 3600, "/");
                        setcookie('password', $data_mahasiswa['password'], time() - 3600, "/");
                    }
                    else {
    ...
    private function getJurusan($jurusan){
        ...
        if($data_mahasiswa['jurusan'] == 'kedokteran'){
            $kode_jurusan = 11
        }
        elseif($data_mahasiswa['jurusan'] == 'psikologi'){
            $kode_jurusan = 12
        }
        elseif($data_mahasiswa['jurusan'] == 'biologi'){
            $kode_jurusan = 13
        }
        elseif($data_mahasiswa['jurusan'] == 'teknik informatika'){
            $kode_jurusan = 14
        }
    ...
    public function register_step_1()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            $query1 = "SELECT * FROM pendaftaran WHERE id = '$id_pendaftaran' AND status = 'lulus'";
            ...
            //    - Jangan lupa exit setelah redirect
                $_SESSION["user"] = $data_pendaftaran["id_pendaftaran"];
            ...
            //    - Set session message error
                ...
                $_SESSION['message'] = "Session Error";
                $_SESSION['color'] = 'danger';
            }
        }
    ...
    public function register_step_2() 
    {
        ...
        //    - Jangan lupa exit setelah redirect
        if($_SESSION["user"] =/ $data_pendaftaran['id_pendaftaran']){
