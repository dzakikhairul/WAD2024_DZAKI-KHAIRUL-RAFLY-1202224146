        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <h3>Masukkan nilai mata kuliah anda pada form dibawah ini</h3>
                    ...
                    //  **********************  4  **************************     
                    if ($_POST){
                        $KI1201 = $_POST["MK_KI1201"];
                        $KU1202 = $_POST["MK_KU1202"];
                        $KU1102 = $_POST["MK_KU1102"];
                    }
                    if (empty($KI1201) || empty($KU1202) || empty($KU1102)){
                        $error = "Field tidak boleh kosong";
                    }
                    else {
                        if ($KI1201 == "A"){
                            $hasil = "dapat memilih Kimia Umum";
                        } elseif ($KU1202 == "AB" or  $KU1202 == "A"){
                            if($KU1102 == "B" || $KU1102 == "AB" || $KU1102 == "A")
                            $hasil = "dapat memilih Kimia Pangan";
                        } else {
                            $hasil = "Tidak dapat memilih Kimia Pangan maupun Kimia Umum";
                        }
                    }

                    if (!empty($hasil)){
                        echo "<div class='alert alert-success'>Kamu $hasil</div>";
                    }
                    //  **********************  4  ************************** 
